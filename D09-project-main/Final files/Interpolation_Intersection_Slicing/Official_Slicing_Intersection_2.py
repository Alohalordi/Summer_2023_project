...
def eXportcsv_allslices(X_sc, Y_sc, U_intp, V_intp, density, z_def, path_to_Entire_layers_folder, proceed):
    num_slice = 0
    if proceed:
        for i in range(z_def):
            ...
            layerheader= (f"X, Y, u, v, rho       # ADD COMMENTS HERE. Specific layer {num_slice+1}")
