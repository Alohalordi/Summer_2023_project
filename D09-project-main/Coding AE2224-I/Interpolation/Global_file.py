...
from otherdirectionsOfficial_Interpolation import inTerPolation
from Official_Slicing_Intersection import sCale, inTersection, geTOneslice, eXportcsv, eXportcsv_allslices
import pandas as pd
...
eXportcsv_allslices(X_sc, Y_sc, U_intp, V_intp, density, z_def, path_to_Entire_layers_folder, proceed)